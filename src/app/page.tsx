...
export default function Home() {
  return (
    <main>
      {/* section 1 */}
      <section>
        <div className='flex flex-col items-center justify-start bg-[url("/texture3.jpg")] bg-cover bg-center min-h-[84vh] shadow-md'>
          <Navbar typ={3}/>
      ...
      {/* section 2 */}
      <section>
        <div className='bg-[url("/texture3.jpg")] bg-cover bg-center flex flex-col items-center justify-center mt-1 shadow-md'>
          {/* text */}
      ...
      {/* section 4 */}
      <section>
        <div className='flex flex-col items-center justify-start w-full min-h-[60vh] mt-1 bg-[url("/texture3.jpg")] bg-cover bg-center shadow-md'>
          {/* text */}
      ...
      {/* section 5 */}
      <section>
        <div className='flex flex-col mt-1 items-center justify-start shadow-md w-full bg-[url("/texture3.jpg")] bg-cover bg-center min-h-screen'>
          {/* text */}
          <div className='flex flex-col text-center items-center justify-center p-6 md:p-12 gap-y-6 w-full'>
            {/* title */}
      ...
      {/* section 6 */}
      <section>
        <div className='bg-[url("/texture3.jpg")] bg-cover bg-center flex flex-col items-center justify-center shadow-md mt-1'>
          {/* text */}
          <div className='flex flex-col text-center items-center justify-center p-6 md:p-12 gap-y-6'>
            {/* title */}
